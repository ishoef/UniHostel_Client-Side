...
export default function MealsByCategory() {
  ...
  return (
    <div className="py-12 px-4 max-w-7xl mx-auto">
      <h2 className="text-3xl sm:text-4xl font-extrabold text-center mb-3 text-gray-800 dark:text-white">
        Meals by{" "}
      ...
      <div className="flex justify-center">
        <Link
          to={"/meals"}
          className="bg-black text-white text-sm py-2 px-6 rounded-md hover:opacity-90 dark:bg-white dark:text-black"
        >
          View All Meals
        </Link>
      </div>
